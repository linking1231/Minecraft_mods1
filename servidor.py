...
def is_file_in_use(filepath):
    try:
        # Intenta renombrar el archivo para ver si está en uso
...
def download_latest_release(download_path='.'):
    ...
    if pet.status_code == 200:
        ...
        # Espera hasta que el archivo no esté en uso
        while is_file_in_use(pathto):
            time.sleep(1)  # Espera 1 segundo antes de volver a comprobar

        # Ahora abre el archivo para escritura binaria
